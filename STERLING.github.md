...
- Gemini Pro requires explicit `allow_gemini_pro: true` flag
...
2. Confirm current state with Cash before multi-step work
...
5. Honor Governor routing without override; apply Routing Failure Protocol on mismatches
